 ...
 */
public class TextAdAdd implements JsonSerializableObject {
    ...
    public TextAdAdd(@NotNull String title, @NotNull String text, @NotNull YesNoEnum mobile, @Nullable String href, @Nullable Long vCardId) throws ApiRequestException {
